        ...
        <div className="container h-full mx-auto px-auto flex justify-center items-center">
            <div className="innerbox flex flex-col items-center gap-5 w-full">
                ...
                <div className="w-full flex justify-center">
                    <button className='bg-yellow-300 p-2 w-6/12 h-12 md:w-5/12 rounded-lg ring-4 shadow shadow-yellow-700 font-bold ' onClick={()=> handlePlay("friend")}>NEW GAME (VS FRIEND)</button>
                </div>
                 <div className="w-full flex justify-center">
                    <button className='bg-yellow-300 p-2 w-6/12 h-12 md:w-5/12 rounded-lg ring-4 shadow shadow-yellow-700 font-bold ' onClick={()=> handlePlay("computer")}>NEW GAME (VS COMPUTER)</button>
                </div>
            </div>
