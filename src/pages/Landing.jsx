            ...
            <div className="innerbox flex flex-col items-center gap-5 w-full">
                ...
                <div className="choosemark flex flex-col justify-center items-center gap-3 text-white bg-slate-700 p-3 w-6/12 md:w-5/12 rounded-md ">
                    ...
                    <div className='flex w-full items-center justify-center bg-slate-800 rounded-lg'>
                        <div className='text-center  w-6/12 p-1 rounded-lg font-bold text-2xl cursor-pointer hover:bg-blue-200 hover:text-cyan-500 '>X</div>
                        <div className='text-center  w-6/12 p-1 rounded-lg font-bold text-2xl cursor-pointer hover:bg-blue-200 hover:text-yellow-300'>O</div>

                    </div>
                </div>

                <div className="w-full flex justify-center">
                    <button className='bg-yellow-300 p-2 w-6/12 h-12 md:w-5/12 rounded-lg ring-4 shadow shadow-yellow-700 font-bold'>NEW GAME (VS FRIEND)</button>
                </div>
            </div>
